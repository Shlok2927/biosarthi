...
import { handleMessageSend } from "@/utils/handleSendFunction";
...
export default function ChatInterface({
  ...
  const handleSpeakClick = useCallback(() => {
    toggleSpeechRecognition(); // Call without arguments
  }, [toggleSpeechRecognition]);

  return (
    <div className="flex h-screen bg-gradient-to-br from-green-50 to-blue-50">
      {/* Left static section */}
      <div className="w-[30%] bg-slate-200 p-6 flex flex-col shadow-lg rounded-r-3xl">
        <img
        ...
        <div className="p-4 border-t border-gray-200 bg-white">
          <div className="flex items-center">
            <Input
              ...
              onKeyPress={(e) =>
                e.key === "Enter" &&
                handleMessageSend(inputText, setMessages, setInputText)
              }
            />
            <Button
              onClick={handleSpeakClick} // Fixed to use the correct handler
              className={`mr-2 ${
                isSpeaking
